...
describe('CRAWL CiudadSeva Controller Test', () => {
  describe('Authors index', () => {
    ...
    const scope = nock('https://ciudadseva.com').get('/biblioteca/indice-autor-cuentos/').reply(200, authorsIndex, {
  ...
  describe('Stories index from authors', () => {
    ...
    const scope = nock('https://ciudadseva.com').get('/autor/ciro-alegria/cuentos/').reply(200, storiesAuthorIndex, {
      'content-type': 'text/html'
    });
  ...
  describe('Stories content', () => {
    ...
    const scope = nock('https://ciudadseva.com').get('/texto/gorrioncito/').reply(200, textData, {
      'content-type': 'text/html'
    });
